...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 4.5_Reverse_Height) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
(define (show x)
 (cond
   [(string? x)
    (place-rocket 0)]
   [(<= -3 x -1)
    (place-image (show-text x) 10 (* 3/4 WIDTH) (place-rocket 0))]
   [(>= x 0)
    (place-rocket x)]))
